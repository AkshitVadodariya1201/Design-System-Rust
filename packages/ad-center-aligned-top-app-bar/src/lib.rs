...
impl ButtonComponent {
    fn new() -> Self {
        ...
        let htmltemplate: String = include_str!("ad-center-aligned-top-app-bar.html").into();
        console_log!("{}", "html");
        let element = customelement::create_element_from_html(
            &htmltemplate.as_str(),
            "ad-center-aligned-top-app-bar",
        )
        .unwrap();
        Self { element }
    }
...
impl CustomElement for ButtonComponent {
    fn inject_children(&mut self, this: &HtmlElement) {
        ...
        let css = include_str!("ad-center-aligned-top-app-bar.css").into();
    ...
    fn observed_attributes() -> &'static [&'static str] {
        &["title", "disabled", "icon", "trailingicon"]
    }
...
pub fn run() -> Result<(), JsValue> {
    ...
    ButtonComponent::define("ad-center-aligned-top-app-bar");
