...
impl ButtonComponent {
    fn new() -> Self {
        ...
        let htmltemplate: String = include_str!("ad-bottom-app-bar.html").into();
        console_log!("{}", "html");
        let element =
            customelement::create_element_from_html(&htmltemplate.as_str(), "ad-bottom-app-bar")
                .unwrap();
        Self { element }
    }
...
impl CustomElement for ButtonComponent {
    fn inject_children(&mut self, this: &HtmlElement) {
        ...
        let css = include_str!("ad-bottom-app-bar.css").into();
        inject_style(&this, css);
        let css_one = include_str!("../../../tokens/css/components/bottom-app-bar.css").into();
...
pub fn run() -> Result<(), JsValue> {
    ...
    ButtonComponent::define("ad-bottom-app-bar");
